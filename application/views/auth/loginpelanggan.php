                            ...
                            <div class="col-lg-6">
                                <div class="p-4">
                                    <div class="text-center">
                                        <h1 class="h4 text mb-4-0" style="color: greenyellow;"><b>Login Pelanggan</b></h1>
                                    </div>
                                    <?= $this->session->flashdata('message'); ?>
                                    <form class="user" method="post" action="<?= base_url('auth/loginpelanggan'); ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="id_pelanggan" name="id_pelanggan" placeholder="Masukan Id Pelanggan" value="<?= set_value('id_pelanggan'); ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="<?php echo base_url('Auth'); ?>" class="btn btn-primary btn-user btn-block" style="font-family: Arial, Helvetica, sans-serif;color: greenyellow;">Login Karyawan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-center">
